...
var robotSymbolTable = map[string]reflect.Value{
	...
	"BeginRun":                  reflect.ValueOf(robot.BeginRun),
	"SetConstraints":            reflect.ValueOf(robot.SetConstraints),
	"GetConstraints":            reflect.ValueOf(robot.GetConstraints),
	"ClearConstraints":          reflect.ValueOf(robot.ClearConstraints),
	"SetGoal":                   reflect.ValueOf(robot.SetGoal),
	"GetGoal":                   reflect.ValueOf(robot.GetGoal),
	"ClearGoal":                 reflect.ValueOf(robot.ClearGoal),
	"CurrentRunStats":           reflect.ValueOf(robot.CurrentRunStats),
	"RunStatsSnapshot":          reflect.ValueOf(robot.RunStatsSnapshot),
	"EvaluateGoal":              reflect.ValueOf(robot.EvaluateGoal),
	"GoalEvaluationSnapshot":    reflect.ValueOf(robot.GoalEvaluationSnapshot),
	"IsConstraintReachedError":  reflect.ValueOf(robot.IsConstraintReachedError),
	...
	"CurrentWorldState":         reflect.ValueOf(robot.CurrentWorldState),
	"CurrentWorldRef":           reflect.ValueOf(robot.CurrentWorldRef),
	"Robot":                     reflect.ValueOf((*robot.Robot)(nil)),
	"RobotState":                reflect.ValueOf((*robot.RobotState)(nil)),
	"WorldState":                reflect.ValueOf((*robot.WorldState)(nil)),
	"Constraints":               reflect.ValueOf((*robot.Constraints)(nil)),
	"GoalType":                  reflect.ValueOf((*robot.GoalType)(nil)),
	"Goal":                      reflect.ValueOf((*robot.Goal)(nil)),
	"RunStats":                  reflect.ValueOf((*robot.RunStats)(nil)),
	"GoalEvaluation":            reflect.ValueOf((*robot.GoalEvaluation)(nil)),
	"World":                     reflect.ValueOf((*robot.World)(nil)),
	"Point":                     reflect.ValueOf((*robot.Point)(nil)),
	"Direction":                 reflect.ValueOf((*robot.Direction)(nil)),
	"GoalNone":                  reflect.ValueOf(robot.GoalNone),
	"GoalCollectAllBeepers":     reflect.ValueOf(robot.GoalCollectAllBeepers),
	"GoalCollectAtLeastBeepers": reflect.ValueOf(robot.GoalCollectAtLeastBeepers),
	"GoalVisitAllCells":         reflect.ValueOf(robot.GoalVisitAllCells),
	"GoalVisitAtLeastCells":     reflect.ValueOf(robot.GoalVisitAtLeastCells),
